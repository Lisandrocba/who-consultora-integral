export const translations = {
  es: {
    ...
    juan: "CO Fundador",
    juanDescripcion: "Con una vasta experiencia en la selección de profesionales del ámbito técnico. Su profundo entendimiento de las tecnologías emergentes, los requisitos específicos de roles IT y de ingeniería, y las tendencias del mercado laboral técnico, le permite liderar un equipo de selectores que podrán identificar y evaluar de manera precisa a los talentos más adecuados para posiciones especializadas.",
    ...
    sendButton: "Enviar",
    msjSucces: "¡Mensaje enviado correctamente!",
    msjSucces2: "Gracias por contactarnos. Te responderemos pronto.",
    campoRequerido: "Este campo es requerido",
    emailValido: 'Ingresa un email válido',
  ...
  en: {
    ...
    juan: "Co-Founder",
    juanDescripcion: "With extensive experience in the selection of professionals in the technical field. His deep understanding of emerging technologies, the specific requirements of IT and engineering roles, and the trends in the technical labor market allows him to lead a team of selectors who can accurately identify and evaluate the most suitable talents for specialized positions.",
    ...
    sendButton: "Send",
    msjSucces: "Message sent successfully!",
    msjSucces2: "Thank you for contacting us. We will respond soon.",
